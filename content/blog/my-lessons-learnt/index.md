...
5. When we copy code or use code someone else wrote we think we know what is going on but really we don't. It takes a long to be a competent programmer so be patient. ![Confidence vs competence graph](/confidence-vs-competence.jpg)
