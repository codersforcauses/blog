...
<h1 align="center">
  Coders for Causes Blog using Gatsby
</h1>
...
3. **Create a new blog post**
    ...
    Create a new folder with appropriate title in `content/blog/`

    Create an index.md inside please follow the format of the other posts
